    ...
    return (
        <div>
            <div style={inputStyle}>
                <TextField size="small" type="text" label="поиск" variant="standard" />
                <Button onClick={openSearch} variant="outlined" size="small">
                    x
                </Button>
            </div>

            <Button style={searchStyle} onClick={openSearch} variant="outlined" size="small">
                поиск
            </Button>
        </div>
    );
